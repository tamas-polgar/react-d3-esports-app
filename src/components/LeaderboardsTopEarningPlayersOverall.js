...
function LeaderboardsTopEarningPlayersOverall() {
  return (
    <article className='screen screen--sub'>
      <h1 className='screen__heading'>TOP EARNING PLAYERS</h1>

      <ul className='screen__desc'>
        <li className='screen__desc__i'>
          By virtue of Evil Geniuses winning Dota 2's The International 2015
          tournament and placing 3rd in The International 2016, teammates
          UNiVeRsE, ppd, SumaiL and Fear occupy the top four spots.
        </li>
        <li className='screen__desc__i'>
          Similarly, teammates iceice, bLink, y`, Faith_bian and Shadow of Wings
          Gaming scooped the top prize in the The International 2016 ($1.83
          million).
        </li>
      </ul>
      ...
      <div className='table-data table-data--7-col'>
        <div className='table-filters'>
          ...
          <select className='table-filter'>
            ...
            <option value='Age of Empires II: The Age of Kings'>
              Age of Empires II: The Age of Kings
            </option>
            <option value='Call of Duty: Advanced Warfare'>
              Call of Duty: Advanced Warfare
            </option>
            <option value='Call of Duty: Black Ops 2'>
              Call of Duty: Black Ops 2
            </option>
            <option value='Call of Duty: Black Ops III'>
              Call of Duty: Black Ops III
            </option>
            <option value='Call of Duty: Ghosts'>Call of Duty: Ghosts</option>
            <option value='Call of Duty: Modern Warfare 3'>
            ...
            <option value='Hearthstone: Heroes of WarCraft'>
            ...
            <option value='Super Smash Bros. for Wii U'>
              Super Smash Bros. for Wii U
            </option>
            <option value='Turbo Racing League'>Turbo Racing League</option>
            <option value='Ultra Street Fighter IV'>
        ...
        <div className='table-wrap'>
          <div className='table-inner'>
            <div className='table__head'>
              ...
              <div className='table__th'>Total Winnings</div>
              <div className='table__th table__th--reverse'>Main Game</div>
              <div className='table__th'>Winnings from Main Game</div>
            </div>

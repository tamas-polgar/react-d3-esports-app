...
function GamesCounterStrikeGlobalOffensive() {
  ...
  useEffect(() => {
    ...
    // LOADING DATA
    function loadData() {
      const csvFilePath = 'data/games_counter-strike-global-offensive.csv';
...
export default GamesCounterStrikeGlobalOffensive;

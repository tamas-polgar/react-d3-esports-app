...
function GamesLeagueOfLegends() {
  ...
  useEffect(() => {
      ...
      function tooltip() {
        ...
        function mousemove() {
          ...
          focus
            ...
            .text(pageData.cat4_sub1_txt1 + ': $' + d3.format(',')(d['prize-awarded']))
            .attr('fill', '#aa2568');
          focus
            .select('.lineHoverText:nth-of-type(3)')
            .text(
              pageData.cat4_sub1_txt2 + ': ' + d3.format(',')(d['number-of-pros'])
            )
            .attr('fill', '#0ed19d');
    ...
    // LOADING DATA
    function loadData() {
      data = vizData['games|league-of-legends'].elements;
  ...
  return (
    <article className='screen screen--sub'>
      <h1 className='screen__heading'>{pageData.cat4_sub2_title}</h1>

      <ul className='screen__desc'>
        <li className='screen__desc__i'>{pageData.cat4_sub2_desc1}</li>
        <li className='screen__desc__i'>{pageData.cat4_sub2_desc2}</li>
      </ul>
...
export default GamesLeagueOfLegends;

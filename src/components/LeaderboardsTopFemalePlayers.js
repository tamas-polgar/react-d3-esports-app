...
function IndustryEsportsViewership() {
  return (
    <article className='screen screen--sub'>
      <h1 className='screen__heading'>TOP FEMALE PLAYERS BY WINNINGS</h1>

      <ul className='screen__desc'>
        <li className='screen__desc__i'>
          With lifetime earnings of $171,185, Starcraft II pro Sasha Hostyn is
          the most successful female gamer.
        </li>
        <li className='screen__desc__i'>
          Despite not placing in a tournament since 2010, popular streamer
          Mystik ranks second ($122,000) following her $100,000 prize in a WCG
          Halo event.
        </li>
      </ul>
